...
class USCLogger :
 ...
 def logAutoEncoderStepEnd(self,session,prepareDataTimes,trainingTimes,trainingAccuracies,trainingIterationNo):
    ...
    self.logger.info("AutoEncoder Mean Training Accuracy : "+str(np.mean(trainingAccuracies)))
    self.logger.info("AutoEncoder Max Training Accuracy : "+str(np.max(trainingAccuracies)))
    self.logger.info("AutoEncoder Min Training Accuracy : "+str(np.min(trainingAccuracies)))
