...
###   layer_input = keras.layers.Input(batch_shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices*self.uscData.latent_space_presentation_data_length,1))
   layer_input = keras.layers.Input(batch_shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices,self.uscData.time_slice_length))
   out=keras.layers.Convolution1D(128, 3,activation='relu', border_mode='same')(layer_input) # out.shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices,128)
   out=keras.layers.Convolution1D(8, 3,activation='relu', border_mode='same')(out) # out.shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices,8)
   out=keras.layers.Convolution1D(8, 3,activation='relu', border_mode='same')(out) # out.shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices,8)
   out=keras.layers.Convolution1D(8, 3,activation='relu', border_mode='same')(out) # out.shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices,8)
