...
#  print("")
  ...
  return trainingTime,trainingAccuracy_1,trainingAccuracy_2,trainingAccuracy_adverserial,loss_single,prepareDataTime,confusion1,confusion2
 ...
 def test(self,data):
  ...
  return testTime,testAccuracy_1,testAccuracy_2,testAccuracy_adverserial,confusion1,confusion2
