...
class USCAutoEncoder :
 ...
 def buildModel(self):
   ...
   x =keras.layers.Dense(units =128,activation='relu')(layer_input)
   ...
   #autoencoder.compile(optimizer=selectedOptimizer, loss='categorical_crossentropy')
...
#   model = keras.models.Model(inputs=inputs, outputs=[out])
 ...
 def encode(self,x_data):
   ...
   for x_data_item in x_data_list :
       ...
       x_data_item=x_data_item.reshape(x_data_item.shape[0],x_data_item.shape[1])
