...
class USCModel :
 ...
 def buildModel(self):
   ...
   l1=out
   l1_reshaped=keras.layers.Reshape((out.shape[1],1))(out)
   
   
   out=keras.layers.Convolution1D(32, 16,strides=4,activation='relu', padding='same')(l1_reshaped)
   out=keras.layers.Dropout(0.2)(out)
   out=keras.layers.Convolution1D(32, 16,strides=4,activation='relu', padding='same')(out)
   out=keras.layers.Dropout(0.2)(out)
   out=keras.layers.Convolution1D(32, 16,strides=4,activation='relu', padding='same')(out)
   ...
   out=keras.layers.BatchNormalization()(out)
   l2=out
   l2_concat=keras.layers.concatenate([l1,l2])
   l2_concat_reshaped=keras.layers.Reshape((l2_concat.shape[1],1))(l2_concat)

   out=keras.layers.Convolution1D(32, 16,strides=4,activation='relu', padding='same')(l2_concat_reshaped)
   out=keras.layers.Dropout(0.2)(out)
   out=keras.layers.Convolution1D(32, 16,strides=4,activation='relu', padding='same')(out)
   out=keras.layers.Dropout(0.2)(out)
   out=keras.layers.Convolution1D(32, 16,strides=4,activation='relu', padding='same')(out)
   ...
   out=keras.layers.BatchNormalization()(out)
   l3=out
   l3_concat=keras.layers.concatenate([l2,l3])
   
   out=keras.layers.Dense(units=32,activation='sigmoid')(l3_concat)
