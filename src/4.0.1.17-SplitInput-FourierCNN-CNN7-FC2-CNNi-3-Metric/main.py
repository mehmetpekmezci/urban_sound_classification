...
#  logger.info("##############################################################")
  ...
  with tf.Session() as session:
   ...
   for trainingIterationNo in range(TRAINING_ITERATIONS):
    ...
    trainingAccuracies_3=[ ]
    trainingAccuracies_metric_1_2=[ ]
    trainingAccuracies_metric_1_3=[ ]
    trainingAccuracies_metric_2_3=[ ]
    testTimes=[ ]
    testAccuracies_1=[ ]
    testAccuracies_2=[ ]
    testAccuracies_3=[ ]
    testAccuracies_metric_1_2=[ ]
    testAccuracies_metric_1_3=[ ]
    testAccuracies_metric_2_3=[ ]
       ...
       for current_batch_counter in range(int(current_fold_data.shape[0]/MINI_BATCH_SIZE)) :
         ...
         if fold == "fold10":
             ## FOLD10 is reserved for testing
              ...
              batch_data_3=np.random.permutation(batch_data)
              testTime,testAccuracy_1,testAccuracy_2,testAccuracy_3,testAccuracy_metric_1_2,testAccuracy_metric_1_3,testAccuracy_metric_2_3=neuralNetworkModel.test(batch_data_1,batch_data_2,batch_data_3)
              testTimes.append(testTime)
              testAccuracies_1.append(testAccuracy_1)
              testAccuracies_2.append(testAccuracy_2)
              testAccuracies_3.append(testAccuracy_3)
              testAccuracies_metric_1_2.append(testAccuracy_metric_1_2)
              testAccuracies_metric_1_3.append(testAccuracy_metric_1_3)
              testAccuracies_metric_2_3.append(testAccuracy_metric_2_3)
         else:
              batch_data_1=batch_data
              batch_data_2=np.random.permutation(batch_data)
              batch_data_3=np.random.permutation(batch_data)
              ...
              trainingTime,trainingAccuracy_1,trainingAccuracy_2,trainingAccuracy_3,trainingAccuracy_metric_1_2,trainingAccuracy_metric_1_3,trainingAccuracy_metric_2_3,loss_adverserial,prepareDataTime=neuralNetworkModel.train(batch_data_1,batch_data_2,batch_data_3)
              ...
              trainingAccuracies_3.append(trainingAccuracy_3)
              trainingAccuracies_metric_1_2.append(trainingAccuracy_metric_1_2)
              trainingAccuracies_metric_1_3.append(trainingAccuracy_metric_1_3)
              trainingAccuracies_metric_2_3.append(trainingAccuracy_metric_2_3)
    ...
    logger.info("Mean Training Accuracy_3 : "+str(np.mean(trainingAccuracies_3)))
    logger.info("Mean Training Accuracy_metric_1_2 : "+str(np.mean(trainingAccuracies_metric_1_2)))
    logger.info("Mean Training Accuracy_metric_1_3 : "+str(np.mean(trainingAccuracies_metric_1_3)))
    logger.info("Mean Training Accuracy_metric_2_3 : "+str(np.mean(trainingAccuracies_metric_2_3)))
    ...
    if len(testAccuracies_1) > 0 :
      ...
      logger.info("Mean Test Accuracy_3 : "+str(np.mean(testAccuracies_3)))
      logger.info("Mean Test Accuracy_metric_1_2 : "+str(np.mean(testAccuracies_metric_1_2)))
      logger.info("Mean Test Accuracy_metric_1_3 : "+str(np.mean(testAccuracies_metric_1_3)))
      logger.info("Mean Test Accuracy_metric_2_3 : "+str(np.mean(testAccuracies_metric_2_3)))
