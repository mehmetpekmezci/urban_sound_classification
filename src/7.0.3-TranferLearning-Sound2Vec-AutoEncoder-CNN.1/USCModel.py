...
class USCModel :
 ...
 def buildModel(self):
   ...
   out = keras.layers.Convolution1D(13, 3,activation='relu', border_mode='same')(layer_input) #nb_filter, nb_row, nb_col
   out = keras.layers.Convolution1D(13, 3, activation='relu', border_mode='same')(out)
   out = keras.layers.Convolution1D(13, 3, activation='relu', border_mode='same')(out)
   out = keras.layers.Convolution1D(13, 3, activation='relu', border_mode='same')(out)
   out = keras.layers.Convolution1D(13, 3, activation='relu', border_mode='same')(out)
   out = keras.layers.Convolution1D(13, 3, activation='relu', border_mode='same')(out)
