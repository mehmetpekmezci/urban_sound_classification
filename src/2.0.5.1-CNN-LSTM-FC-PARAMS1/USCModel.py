...
class USCModel :
 ...
 def buildModel(self):
   layer_input = keras.layers.Input(batch_shape=(self.uscData.mini_batch_size,self.uscData.number_of_time_slices,self.uscData.time_slice_length,1))
   out=keras.layers.TimeDistributed(keras.layers.Conv1D(32,(3),strides=2))(layer_input)
   out=keras.layers.BatchNormalization()(out)
   out=keras.layers.TimeDistributed(keras.layers.Conv1D(32,(3),strides=2))(out)
   out=keras.layers.BatchNormalization()(out)
   out=keras.layers.TimeDistributed(keras.layers.Conv1D(32,(3),strides=2))(out)
   out=keras.layers.BatchNormalization()(out)
   out=keras.layers.TimeDistributed(keras.layers.Conv1D(32,(3),strides=2))(out)
   ...
   out=keras.layers.LSTM(self.lstm_size,dropout=0.2,recurrent_dropout=0.2)(out)
   out=keras.layers.BatchNormalization()(out)
   ...
   selectedOptimizer=keras.optimizers.Adam(lr=0.00001)
