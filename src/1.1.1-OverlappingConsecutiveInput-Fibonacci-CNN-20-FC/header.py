...
TIME_SLICE_LENGTH=int(TRACK_LENGTH/20)
TIME_SLICE_OVERLAP_LENGTH=int(TIME_SLICE_LENGTH/2)
NUMBER_OF_TIME_SLICES=math.ceil(TRACK_LENGTH/(TIME_SLICE_LENGTH-TIME_SLICE_OVERLAP_LENGTH))
